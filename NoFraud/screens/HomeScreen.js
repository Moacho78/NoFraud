...
export default function HomeScreen({ navigation }) {
    ...
    const cargarDatos = async () => {
        try {
            ...
            // 🔹 Obtener créditos
            const listaCreditos = await obtenerCreditos(uid);
    ...
    const renderCredito = ({ item }) => (
        ...
        >
            ...
            < View style={styles.cardBody} >
                ...
                <Text style={styles.cardText}>Tipo de crédito:  {item.tipo_credito}</Text>
            </View >
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.title}>Hola, {nombre || "Usuario"} 👋</Text>
                <Text style={styles.subtitle}>
                    Estos son tus créditos activos
                </Text>
            </View>
